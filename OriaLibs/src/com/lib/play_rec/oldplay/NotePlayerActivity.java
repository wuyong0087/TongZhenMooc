...
public class NotePlayerActivity extends BaseActivity implements OnClickListener {
...
//		noteViewPager.setAdapter(adapter);
		noteViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int pageNum) {
				...
				NotePlayerActivity.this.pageNum = pageNum;
...
//			noteShare.showPopupWindow(v, pageNum, noteBean);
	...
	private void thisOut() {
		...
		NotePlayerActivity.this.setResult(RESULT_OK, data);
		ScreenManager.getInstance().popActivity(NotePlayerActivity.this);
	}
