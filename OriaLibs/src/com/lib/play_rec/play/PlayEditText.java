...
public class PlayEditText extends EditText{
	...
	public PlayEditText(VideoPlayerBaseAty player,int x,int y,
	...
	public void startMoveText(){
		memory = new PlayHistoryMemory(2);
	...
	/** 以文本中心点进行布局    */
	public void setLayoutByMid(float left,float top,boolean refresh){
