...
public class PlayImageView extends ImageView {
	...
	private float[] move;
	private PlayHistoryMemory memory;

	public PlayImageView(VideoPlayerBaseAty player, int x, int y,
			Bitmap bmp, int mid) {
		super(player);
		this.player = player;
		this.mid = mid;
	...
	public PlayImageView(PlayViewGroup viewGroup,
			VideoPlayerBaseAty player, int x, int y, String filePath, int mid,
		...
		Bitmap bitmap = BitmapUtil.getScaleBitmap3(bmp, width, height,
				isHsaScale);*/
		// TODO 设置例子的图片
		this.setImageResource(R.drawable.demo);
		posLeft = x;
		posTop = y;
...
//		this.setImageBitmap(bitmap);
	...
	public void startMove() {
		memory = new PlayHistoryMemory(3);
