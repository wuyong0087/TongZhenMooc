 ...
 */
public class CheckNicknameUseCase extends BaseUseCase<BaseInfo> {
    private final SessionRepository sessionRepository;
    private String nickname;

    @Inject
    protected CheckNicknameUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<BaseInfo> buildUseCaseObservable() {
        return sessionRepository.check_nickname(nickname);
    }
