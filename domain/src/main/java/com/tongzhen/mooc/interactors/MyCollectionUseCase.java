 ...
 */
public class MyCollectionUseCase extends BaseUseCase<WorksListInfo> {
    ...
    @Inject
    protected MyCollectionUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<WorksListInfo> buildUseCaseObservable() {
        return sessionRepository.my_collection(uid, page + "", max + "");
    }
