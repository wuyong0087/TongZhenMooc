 ...
 */
public class MyFollowsUseCase extends BaseUseCase<UserListInfo> {
    private final SessionRepository sessionRepository;
    private String uid;

    @Inject
    protected MyFollowsUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<UserListInfo> buildUseCaseObservable() {
        return sessionRepository.my_follows(uid);
    }
