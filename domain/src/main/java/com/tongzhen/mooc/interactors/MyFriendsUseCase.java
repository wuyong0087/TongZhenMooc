 ...
 */
public class MyFriendsUseCase extends BaseUseCase<UserListInfo> {
    private final SessionRepository sessionRepository;
    private String uid;

    @Inject
    protected MyFriendsUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<UserListInfo> buildUseCaseObservable() {
        return sessionRepository.my_friends(uid);
    }
