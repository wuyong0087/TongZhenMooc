 ...
 */
public class TitleUseCase extends BaseUseCase<TitleListInfo> {
    private final SessionRepository sessionRepository;

    @Inject
    protected TitleUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
        super(subscribeOn, observeOn);
        this.sessionRepository = sessionRepository;
    }

    @Override
    protected Observable<TitleListInfo> buildUseCaseObservable() {
        return sessionRepository.title();
    }
}
