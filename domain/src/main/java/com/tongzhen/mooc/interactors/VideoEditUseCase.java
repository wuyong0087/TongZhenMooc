 ...
 */
public class VideoEditUseCase extends BaseUseCase<BaseInfo> {
    ...
    @Inject
    protected VideoEditUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<BaseInfo> buildUseCaseObservable() {
        return sessionRepository.video_edit(vid, uid, title, tags);
    }
