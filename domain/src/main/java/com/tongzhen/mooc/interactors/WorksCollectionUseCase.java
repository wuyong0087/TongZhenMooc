 ...
 */
public class WorksCollectionUseCase extends BaseUseCase<BaseInfo> {
    ...
    @Inject
    protected WorksCollectionUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<BaseInfo> buildUseCaseObservable() {
        return sessionRepository.works_collection(vid, uid, val);
    }
