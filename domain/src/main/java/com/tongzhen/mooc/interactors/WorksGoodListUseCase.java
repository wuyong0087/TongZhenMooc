 ...
 */
public class WorksGoodListUseCase extends BaseUseCase<WorksListInfo> {
    ...
    @Inject
    protected WorksGoodListUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, SessionRepository sessionRepository) {
    ...
    protected Observable<WorksListInfo> buildUseCaseObservable() {
        return sessionRepository.works_good_list(uid, page + "", max + "");
    }
