...
import com.tongzhen.mooc.presenters.SharedWorksPresenter;
...
public class SharedWorksListFrag extends WorksListFragment {

    @Inject SharedWorksPresenter presenter;
